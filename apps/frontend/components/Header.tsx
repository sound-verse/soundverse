      ...
      <div className={styles.headerWrapperToo}>
        ...
        <div className={styles.linkWrapper}>
          ...
          <div class="flex items-center">
            <img class="w-[20px]  h-[20px]" src="/icons8-home.svg" alt="next" />
          <Link href="/soundverses" passHref>
          ...
          <div class="flex items-center ">
            <img className="w-[30px]  h-[30px]" src="/icons8-dollar-coin.svg" alt="next"/>
...
<div class="flex items-center ">
  <img className="w-[20px]  h-[20px]" src="/icons8-sparkling.svg" alt="next"/>
  <Link href="/mint" passHref>
    <p className={styles.marketplaceLink}>Mint</p>
          ...
          <div class="flex items-center">
            ...
            <img className="w-[25px]  h-[25px]" src="/icons8-launch.svg" alt="next"/>
