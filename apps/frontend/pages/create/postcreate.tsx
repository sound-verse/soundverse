    ...
    <div>
      <Head>
        ...
        {latestDrops.map((data, key) => (
          ...
          <h2>Low Ask Price <sup> USD </sup></h2>
          <h1>Lowest Ask</h1>

          
          <h2>Top Price <sup> USD </sup></h2>
          <h1>Top Price</h1>
          <div>
          <button className =  " border rounded-full bg-purple-900 w-full"> Share</button>
          </div>
          <div>

          <button className =  " border rounded-full bg-gray-500 w-full"> Place for Sale</button>
          </div>
